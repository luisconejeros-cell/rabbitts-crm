    ...
    <div style={{display:'flex',flexDirection:'column',gap:16}}>
      ...
      <div style={{background:B.light,border:'1px solid '+B.border,borderRadius:12,padding:'16px'}}>
        ...
        <div style={{fontSize:12,color:'#6b7280',padding:'8px 12px',background:'#fff',borderRadius:8,border:'1px solid #e5e7eb'}}>
          💡 <strong>Qué subir:</strong> Personalidad del agente, guión de ventas, proyectos inmobiliarios, preguntas frecuentes, precios, zonas. Formato: <strong>.txt</strong> o <strong>.md</strong> (recomendado), también .csv, .html. Para PDFs: primero cópialos como texto.
        </div>
      </div>
      ...
      >
        ...
        <div style={{fontSize:12,color:B.mid}}>.txt, .md, .csv, .html — hasta 15.000 caracteres por archivo</div>
        <input ref={fileRef} type="file" multiple accept=".txt,.md,.csv,.html,.text"
          style={{display:'none'}}
